...
namespace AccessionWizard
{
    ...
    public partial class AccessionWizard : Form, IGRINGlobalDataWizard
    {
        ...
        private void AccessionWizard_Load(object sender, EventArgs e)
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession", _pKeys, 0, 0);
...
ScrubData(accessionActionChanges);
        ...
        private void BuildAccessionNamePage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_inv_name", _pKeys, 0, 0);
        ...
        private void ux_buttonNewAccessionNameRow_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(pkey, out iPKey) &&
                iPKey > 0)
            {
                DataSet newInventory = _sharedUtils.GetWebServiceData("get_inventory", ":accessionid=" + pkey + ";", 0, 0);
                if (newInventory.Tables.Contains("get_inventory") &&
                    newInventory.Tables["get_inventory"].Rows.Count > 0)
                {
newInventory.Tables["get_inventory"].DefaultView.Sort = "form_type_code asc";
                    newAccessionName["inventory_id"] = newInventory.Tables["get_inventory"].DefaultView[0]["inventory_id"];
                }
            }
        ...
        private void BuildAccessionSourcePage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_source", _pKeys, 0, 0);
        ...
        private void BuildAccessionAnnotationPage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_inv_annotation", _pKeys, 0, 0);
        ...
        private void ux_buttonNewAccessionAnnotationRow_Click(object sender, EventArgs e)
        {
                ...
                iPKey > 0)
            {
                ...
                {
newInventory.Tables["get_inventory"].DefaultView.Sort = "form_type_code asc";
                    newAccessionAnnotation["inventory_id"] = newInventory.Tables["get_inventory"].DefaultView[0]["inventory_id"];
                }
            }
        ...
        private void BuildAccessionVoucherPage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_inv_voucher", _pKeys, 0, 0);
        ...
        private void ux_buttonNewAccessionVoucherRow_Click(object sender, EventArgs e)
        {
                ...
                iPKey > 0)
            {
                ...
                {
newInventory.Tables["get_inventory"].DefaultView.Sort = "form_type_code asc";
                    newAccessionVoucher["inventory_id"] = newInventory.Tables["get_inventory"].DefaultView[0]["inventory_id"];
                }
            }
        ...
        private void BuildAccessionIPRPage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_ipr", _pKeys, 0, 0);
        ...
        private void BuildAccessionQuarantinePage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_quarantine", _pKeys, 0, 0);
        ...
        private void BuildAccessionPedigreePage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_pedigree", _pKeys, 0, 0);
        ...
        private void BuildAccessionActionPage()
        {
            ...
            ds = _sharedUtils.GetWebServiceData("get_accession_action", _pKeys, 0, 0);
