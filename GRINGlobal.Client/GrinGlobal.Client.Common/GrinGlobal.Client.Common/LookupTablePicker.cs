                    ...
                    foreach (DataColumn luColumn in _boundTable.Columns)
                    {
                            ...
                            luColumn.ColumnName != "modified_date")
                        {
                            if (dt.Columns.Contains(luColumn.ColumnName) &&
                                parentRow[luColumn.ColumnName] != null) _filters.Add(luColumn.ColumnName, parentRow[luColumn.ColumnName].ToString().Trim());
                            if (luColumn.ColumnName.StartsWith("is_")) _filters.Add(luColumn.ColumnName, "Y");
                        }
                    }
                }
            }
