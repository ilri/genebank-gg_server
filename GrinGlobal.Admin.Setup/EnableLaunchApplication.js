...
// Configurable values
var checkboxChecked = false;			// Is the checkbox on the finished dialog checked by default?
var checkboxText = "Launch [ProductName]";	// Text for the checkbox on the finished dialog
var filename = "GrinGlobal.Admin.exe";	// The name of the executable to launch - change this to match the file you want to launch at the end of your setup
