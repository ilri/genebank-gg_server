...
/// <summary>
/// Extension for IEnumerable to convert a generic List to a DataSet Offers for an option DataTable name to be assigned to the table. Can be called as a normal method for the IEnumerable generic List
/// SAMPLE USAGE:
...
namespace GrinGlobal.Core
{
    public static class GenericList
    {
        ...
        /// <summary>
        /// (Overload) Method for getting and populating the DataTable that will be in the converted DataSet
        /// </summary>
        /// <typeparam name="T">List type that is being converted</typeparam>
        ...
        /// <summary>
        /// Method for getting and populating the DataTable that will be in the converted DataSet
        /// </summary>
        /// <typeparam name="T">List type that is being converted</typeparam>
        /// <param name="list">The list being converted</param>
        /// <returns>A populated DataTable</returns>
        ...
        /// <summary>
        /// Method for getting the data from the list then create a new DataRow with the property values in the PropertyInfo being provided, then return the row to be added to the Datatable
        /// </summary>
