...
var checkboxText = "Launch [ProductName] To Finish Configuration";	// Text for the checkbox on the finished dialog
var filename = "firstrun.bat";	// The name of the executable to launch - change this to match the file you want to launch at the end of your setup
