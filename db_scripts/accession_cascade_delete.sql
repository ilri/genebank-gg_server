...
where accession_id not in (
	select accession_id from accession where accession_prefix = 'PI' and accession_number between 500000 and 550000
)
...
-- inventory_image
delete from inventory_image where inventory_id in (
	select id from #del_inventory
)
...
-- accession_habitat
delete from accession_habitat where accession_id in (
	select id from #del_accession
)
...
delete from accession_citation_map where accession_id in (
	select id from #del_accession
)
...
-- accession_source
delete from accession_narrative where accession_id in (
	select id from #del_accession
)
